    ...
    Scaffold(
        ...
        Column(
            ...
            SettingSwitchRow(
                ...
                onCheckedChange = {
                    applyChange(config.copy(autoTime = it))
                }
            )
            ...
            SettingSwitchRow(
                ...
                onCheckedChange = {
                    applyChange(config.copy(autoWeather = it))
                }
            )
            ...
            SettingSwitchRow(
                ...
                onCheckedChange = {
                    applyChange(config.copy(animationsEnabled = it))
                }
            )
            ...
            SettingSwitchRow(
                ...
                onCheckedChange = {
                    applyChange(config.copy(ambientSoundEnabled = it))
                }
            )
